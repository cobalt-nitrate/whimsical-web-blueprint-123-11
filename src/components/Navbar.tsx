...
const Navbar = () => {
  ...
  return (
    <nav className={cn("fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300 ease-in-out", isScrolled ? "bg-dark-800/80 backdrop-blur-md shadow-md" : "bg-transparent")}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="px-5 py-2 rounded-full bg-teal-500 hover:bg-teal-600 text-black font-medium transition-all duration-300 text-sm" onClick={scrollToContact}>
            Contact Sales
          </button>
