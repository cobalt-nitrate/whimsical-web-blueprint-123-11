...
const Research = () => {
  ...
  return <section id="research" ref={sectionRef} className="py-20 bg-dark-900 opacity-0">
      <div className="container mx-auto px-6">
        ...
        <div className="rounded-xl p-8 glass-card bg-dark-700 px-[18px] mx-[10px]">
          ...
          <div className="mt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-6">
              {activeVerticalData.capabilities.map((capability, index) => <div key={index} className="p-5 rounded-lg bg-dark-600 px-[10px]">
