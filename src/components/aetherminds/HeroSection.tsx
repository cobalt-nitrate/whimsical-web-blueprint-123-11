      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="w-full md:w-1/2 space-y-6">
            <div className="inline-block px-3 py-1 rounded-full bg-dark-700 text-teal-500 text-xs font-medium mb-2">
              Custom AI Solutions
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              <span className="bg-gradient-to-r from-teal-400 to-teal-600 bg-clip-text text-transparent">Aetherminds</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                ...
                className="px-8 py-3 rounded-full bg-teal-500 hover:bg-teal-600 text-black font-medium transition-all duration-300 flex items-center justify-center"
              >
                Partner With Us
          ...
          <div className="w-full md:w-2/5 flex justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <div className="absolute inset-0 rounded-full bg-dark-800 shadow-[0_0_50px_-12px_rgba(57,223,208,0.3)]"></div>
              
              {/* Brain icon in the center */}
              <div className="absolute inset-0 flex items-center justify-center">
                <Brain className="w-1/2 h-1/2 text-teal-400" />
              </div>
              
              {/* Animated rings */}
              <div className="absolute inset-0 rounded-full border border-teal-500/20 animate-pulse"></div>
              <div className="absolute inset-[15%] rounded-full border border-teal-500/30 animate-pulse" style={{animationDelay: '500ms'}}></div>
              <div className="absolute inset-[30%] rounded-full border border-teal-500/40 animate-pulse" style={{animationDelay: '1000ms'}}></div>
            </div>
          </div>
        </div>
      </div>
