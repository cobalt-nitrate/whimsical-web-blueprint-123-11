...
const ModelTypesSection = () => {
  ...
  const validations = ["Scientifically validated", "Rigorously benchmarked", "Fine-tuned for real-world deployment"];
  return <section className="py-20 bg-dark-900">
      <div className="container mx-auto px-6">
        <SectionHeader badge="Model Portfolio" title="Types of Models We Build" description="Aetherminds develops models across multiple AI and ML categories, tailored to specific industry challenges." align="center" />
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          {modelTypes.map((model, index) => <GradientCard key={index} hover>
        ...
        <div className="mt-16 glass-card p-8 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {validations.map((validation, index) => <div key={index} className="flex items-center space-x-3 p-4 rounded-lg bg-dark-600">
