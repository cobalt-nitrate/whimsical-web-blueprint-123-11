        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {differentiators.map((item, index) => (
              ...
              >
                {/* Icon Container */}
                <div className="w-16 h-16 bg-gradient-to-br from-teal-500/20 to-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:from-teal-500/30 group-hover:to-blue-500/30 transition-all duration-300 group-hover:scale-110">
                ...
                {/* Title */}
                <h3 className="text-sm font-semibold text-white mb-3 group-hover:text-teal-400 transition-colors duration-300">
                  {item.title}
                </h3>
                ...
                {index < differentiators.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-full w-8 transform -translate-x-4">
                    <div className="h-0.5 bg-gradient-to-r from-teal-500/30 to-transparent"></div>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="mt-16 glass-card p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                { step: "01", title: "Research Integration", desc: "Identify breakthrough research" },
                { step: "02", title: "Clinical Validation", desc: "Partner with healthcare institutions" },
                { step: "03", title: "Compliance Engineering", desc: "Build regulatory framework" },
                { step: "04", title: "Production Deployment", desc: "Scale to clinical workflows" }
              ].map((phase, index) => (
