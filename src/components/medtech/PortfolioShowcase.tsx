      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {portfolioItems.map((item, index) => (
            <div
              key={item.id}
              className="glass-card glass-card-hover p-6 rounded-lg transition-all duration-300 cursor-pointer relative overflow-hidden"
            ...
            >
              ...
              <div 
                className={`absolute inset-0 bg-gradient-to-br from-teal-500/5 to-blue-500/5 transition-opacity duration-300 ${
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`transition-transform duration-300 ${
                    hoveredCard === item.id ? 'transform rotate-45' : ''
                  }`}>
                ...
                <div className={`transition-all duration-300 overflow-hidden ${
                  hoveredCard === item.id ? 'max-h-24 opacity-100' : 'max-h-0 opacity-0'
                }`}>
