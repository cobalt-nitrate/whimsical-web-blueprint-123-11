        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            <div className="flex flex-wrap gap-2 mb-6">
              {['Speech Recognition', 'Audio Intelligence', 'Voice Authentication', 'Noise Reduction', 'Audio Classification'].map(tag => (
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Advanced <span className="text-gradient">Speech & Audio</span> Intelligence Solutions
            </h1>
            
            <p className="text-gray-300 text-lg mb-8">
              Creating responsive, real-time audio processing systems with minimal latency for superior speech recognition, audio classification, and voice authentication.
            </p>
          ...
          <div className="hidden md:block relative">
            <div className="relative z-10 glass-card p-6 rounded-xl">
              <div className="aspect-video bg-gradient-to-br from-dark-800 to-dark-700 rounded-lg flex items-center justify-center mb-4">
                <Mic className="w-20 h-20 text-teal-500/70" />
              </div>
            ...
            <div className="absolute -bottom-4 -right-4 glass-card p-4 rounded-lg border border-teal-500/20 teal-glow">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-teal-500">Under 100ms</div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-4 -left-4 glass-card p-4 rounded-lg border border-teal-500/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-teal-500">50+</div>
                </div>
              </div>
            </div>
          </div>
