              ...
              <div className="glass-card p-6 md:p-8 rounded-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mb-3">How MSK Cancer Center Revolutionized Medical Image Analysis</h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      ...
                      <div className="bg-dark-700 p-3 rounded-lg text-center">
                        ...
                        <div className="text-xs text-gray-400">Custom AI models</div>
                      </div>
                      <div className="bg-dark-700 p-3 rounded-lg text-center">
                        <div className="text-2xl font-bold text-teal-500">18%</div>
                        <div className="text-xs text-gray-400">Detection improvement</div>
                      </div>
                    </div>
                    
                    <Link 
                      to="/case-study-msk" 
                      className="inline-flex items-center px-6 py-3 rounded-full bg-teal-500 hover:bg-teal-600 text-black font-medium transition-all duration-300"
                    >
                      Read Case Study
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {filteredCaseStudies.filter(cs => !cs.featured).map((caseStudy) => {
                  ...
                  return (
                    <div 
                      key={caseStudy.id}
                      className="glass-card p-6 rounded-xl border border-white/5 hover:border-teal-500/20 transition-colors duration-300"
                    >
                      ...
                      <Link 
                        ...
                        className={`inline-flex items-center text-sm font-medium group ${
                          caseStudy.id === "msk-cancer-center" 
