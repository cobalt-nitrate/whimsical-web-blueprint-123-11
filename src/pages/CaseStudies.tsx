          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="relative max-w-md mx-auto mt-8">
                ...
                <input type="text" placeholder="Search by industry or technology..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="block w-full pl-10 pr-3 py-2 border border-dark-600 rounded-md leading-5 bg-dark-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition duration-150 ease-in-out sm:text-sm hidden" />
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="hidden md:block aspect-video bg-dark-700 rounded-lg">
                      <div className="w-full h-full flex items-center justify-center">
                        {React.createElement(featuredCaseStudy.icon, {
                      className: "w-16 h-16 text-teal-500/50"
                    })}
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                return <div key={caseStudy.id} className="glass-card p-6 rounded-xl border border-white/5 hover:border-teal-500/20 transition-colors duration-300">
                    ...
                    <Link to={caseStudy.link} className={`inline-flex items-center text-sm font-medium group ${isAvailable ? "text-teal-500 hover:text-teal-400" : "text-gray-400"}`}>
